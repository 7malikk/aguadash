    ...
    <div className=" w-[100%] h-[100vh]">
      <div className="flex pl-[10px]">
        <div className=" hidden md:flex bg-login-bg bg-cover bg-center flex-col w-[50%] p-5 h-screen">
          ...
          <p className="w-[100%] lg:w-[90%] text-center text-white mt-2 mb-8 font-loto text-base md:text-xl lg:text-4xl">
        ...
        <div className="bg-white  w-[100%] flex flex-col  md:w-[65%] md:pl-[100px] mt-[60px]">
          ...
          <div className="pl-[6px] flex flex-col">
            ...
            <button className="w-[100%] border rounded-[20px] p-[4px] mt-[20px] md:w-[50%] bg-[#0e7490] ">
              Login
            </button>
            ...
            <br />
            <button className="w-[97%] ml-[0]  border-2 rounded p-[4px] md:w-[50%] flex justify-between   hover:bg-blue-700 hover:text-white">
              <img
                className="ml-[10px]"
                src={logo}
                alt="logo"
