  ...
  <div className=' w-[100%] h-[100vh]'>
    <ToastContainer
      ...
      <div className='flex pl-[10px]'>
          ...
          <div className='bg-white  w-[100%] flex flex-col  md:w-[65%] md:pl-[100px] mt-[60px]'>           <Link to="/" className='text-[11px] pb-[20px] flex'><IoIosArrowBack className='mt-[4px]'/><span className='pl-[6px]'>back</span></Link>
